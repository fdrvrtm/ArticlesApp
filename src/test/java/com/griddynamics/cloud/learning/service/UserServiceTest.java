...
public class UserServiceTest {
    ...
    public void shouldSaveUserWhenRoleExistsAndReturnDtoAfterwards() {
        ...
        final User newUser = new User(null, username, email, encodedPassword, userRole);
        final User savedUser = new User(id, username, email, encodedPassword, userRole);
    ...
    public void shouldSaveUserWhenRoleNotExistsAndManageRoleProperly() {
        ...
        final NewUserDto userToSaveDto = new NewUserDto(null, username, email, password);
        final User newUser = new User(null, username, email, encodedPassword, generatedUserRole);
